	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'id' then
			...
			elseif msg.text:match("@[%a%d]") then
				...
				return "⚡️ اسم شما: " ..string.gsub(msg.from.print_name, "_", " ").. "\n⚡️ نام کاربری: @"..(msg.from.username or '----').."\n⚡️ آیدی: "..msg.from.id.."\n⚡️ اسم سوپر گروه: " ..string.gsub(msg.to.print_name, "_", " ").. "\n⚡️ آیدی سوپر گروه : "..msg.to.id.. "/n @Blaster_Team
			end
		end
		...
		if matches[1] == 'help' and not is_owner(msg) then
			text = "Message /superhelp to @TGBlaster in private for SuperGroup help"
